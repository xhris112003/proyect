...
12 SYSTEMPATH/CodeIgniter.php(351): CodeIgniter\CodeIgniter->handleRequest(null, Object(Config\Cache), false)
13 FCPATH/index.php(69): CodeIgniter\CodeIgniter->run()
CRITICAL - 2022-12-12 15:03:04 --> Cannot add or update a child row: a foreign key constraint fails
in SYSTEMPATH/Database/MySQLi/Connection.php on line 292.
 1 SYSTEMPATH/Database/MySQLi/Connection.php(292): mysqli->query('INSERT INTO `users` (`name`, `email`, `password`, `username`) VALUES (\'Christian\', \'ccarrasco@stp.es\', \'1234\', \'xhris\')', 0)
 2 SYSTEMPATH/Database/BaseConnection.php(666): CodeIgniter\Database\MySQLi\Connection->execute('INSERT INTO `users` (`name`, `email`, `password`, `username`) VALUES (\'Christian\', \'ccarrasco@stp.es\', \'1234\', \'xhris\')')
 3 SYSTEMPATH/Database/BaseConnection.php(593): CodeIgniter\Database\BaseConnection->simpleQuery('INSERT INTO `users` (`name`, `email`, `password`, `username`) VALUES (\'Christian\', \'ccarrasco@stp.es\', \'1234\', \'xhris\')')
 4 SYSTEMPATH/Database/BaseBuilder.php(1916): CodeIgniter\Database\BaseConnection->query('INSERT INTO `users` (`name`, `email`, `password`, `username`) VALUES (:name:, :email:, :password:, :username:)', [...], false)
 5 SYSTEMPATH/Model.php(279): CodeIgniter\Database\BaseBuilder->insert()
 6 SYSTEMPATH/BaseModel.php(749): CodeIgniter\Model->doInsert([...])
 7 SYSTEMPATH/Model.php(667): CodeIgniter\BaseModel->insert([...], false)
